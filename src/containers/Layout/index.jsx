...
const Layout = ({ dispatch, customizer, sidebar, theme, rtl, user }) => {
  //   useEffect(() => {
  ...
  const changeToGray = () => {
    dispatch(changeThemeToGray());
  };
  const changeToGrayBlack = () => {
    dispatch(changeThemeToGrayBlack());
  };
